...
const RightContact = () => {
  ...
  return (
    <div className="w-full lgl:w-[60%] h-full flex flex-col gap-8 px-8 py-9 bg-gradient-to-r from-[#1e2024] to-[#23272b] rounded-lg shadow-shadowOne">
      <form className="w-full flex flex-col gap-6">
        ...
        <div className="w-full">
          <button
            onClick={handleSend}
            className="w-full h-12 bg-[#141518] rounded-lg text-base text-gray-400 tracking-wider uppercase hover:border-designColor hover:text-lightText border-transparent"
          >
            Send Message
          </button>
        </div>
